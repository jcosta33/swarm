...
| Code | Defect |
|---|---|
| `SOL-V001` | Missing verification path: a binding obligation (`REQ`/`CONSTRAINT`/`INVARIANT`) or an `INTERFACE` with no `VERIFY BY` (§15). |
