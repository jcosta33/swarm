...
`## Self-review` requires verbatim verification output. Paraphrase is not proof. See `.agents/skills/empirical-proof/SKILL.md`.
...
- `.agents/templates/task-feature.md` — the feature task template
- `.agents/templates/spec.md` — the spec doc this task implements from
- `.agents/skills/empirical-proof/SKILL.md` — verification discipline
