...
are **not** bundled in the spec-repo starter kit — a docs/spec repo never runs the `implement` pass, so
...
See [`../../passes/implement.md`](../../passes/implement.md) for the `implement` pass contract and
