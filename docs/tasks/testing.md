...
See [The Test Author's worked example](../personas/the-test-author.md#%EF%B8%8F-example-how-the-test-author-resolves-a-representative-issue) — the `payments.refund` test suite with one-test-per-behaviour and assertion-flip verification.
