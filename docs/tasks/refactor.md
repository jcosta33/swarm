...
See [The Janitor's worked example](../personas/the-janitor.md#%EF%B8%8F-example-how-the-janitor-resolves-a-representative-issue) for a refactor that hits a checkpoint failure and course-corrects.

For the full walkthrough, see [`examples/refactor-walkthrough.md`](../examples/refactor-walkthrough.md).
...
- [`examples/refactor-walkthrough.md`](../examples/refactor-walkthrough.md)
