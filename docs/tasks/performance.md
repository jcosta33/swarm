...
See [The Performance Surgeon's worked example](../personas/the-performance-surgeon.md#%EF%B8%8F-example-how-the-performance-surgeon-resolves-a-representative-issue) — the `parseLargeJSON` 6× speedup with disconfirmed first hypothesis and confirmed second.
