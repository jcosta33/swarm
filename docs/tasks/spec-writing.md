...
See [The Architect's worked example](../personas/the-architect.md#%EF%B8%8F-example-how-the-architect-resolves-a-representative-issue) — the OAuth2 PKCE spec that halts on a `[CRITICAL]` structural decision and spawns an ADR before resuming.

For a full research → spec walkthrough, see [`examples/research-to-spec.md`](../examples/research-to-spec.md).
...
- [`examples/research-to-spec.md`](../examples/research-to-spec.md)
