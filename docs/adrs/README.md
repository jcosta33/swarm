...
| [0040](./0040-kernel-payload-directory.md) | The kernel payload ships under `install/` | **New (kernel)** — §20.5, §34.0 (rename from `scaffold/`, pulled forward from the v0.2 deferral) |
