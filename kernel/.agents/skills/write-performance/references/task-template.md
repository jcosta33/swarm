...
> **Hard gate.** Every question below has a written answer directly beneath it. Performance work fails in two ways — a number that improved on the benchmark but not in production, and a speedup that quietly broke correctness. Review as a senior engineer hostile to both.
...
- Did you ask yourself: "What might still be slow that I didn't profile? Could the speedup be giving back what it gained somewhere downstream?"
  Answer:
