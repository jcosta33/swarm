...
> **DOCUMENTATION SESSION** — User-facing docs (READMEs, contributor guides, ADRs, public API docs). Distinct from agent-facing docs (task templates, skills, internal flow docs), which serve a different audience. The reader is a human who has not read the code; lead with what they need to do.
>
