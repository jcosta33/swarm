...
## Reconcile note
Reconcile applied (option 1 of the 3-way reconcile, §16): the bound proof
...
Note (§16): a STALE verdict is never silently re-blessed — reconcile re-runs, amends, or fixes
