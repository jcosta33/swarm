...
the assigned obligations' WRITES (the two-tier lowering rule, §11.4, §18; a packet writing a
...
merge-time execution (§15) — so its row is `pending` here and resolves at the verify/review
