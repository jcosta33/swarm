...
The suite scores three cross-pass predicates at the `review` output:
...
- [The `review` pass guide](../../docs/passes/review.md) — the skeptic-profile contract, the decorator conditions (R2), and the merge-gate rule (R5) this rubric grades.
- [The flow graph](../../docs/reference/flow-graph.md) — the 7-value verdict model (4 core + 3 lifecycle) R2 checks against.
